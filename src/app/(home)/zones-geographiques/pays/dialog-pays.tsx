...
import { Continent, fetchContinents, Pays, savePays, updatePays } from '@/lib/apis/pays';
...
export function PaysDialog({ open, selectedValue, onClose }: SimpleDialogProps) {
  const {
                ...
                <Stack spacing={2}>
                  ...
                  <FormControl variant="standard" fullWidth size="small">
                    ...
                    {touched.libelle && errors.libelle && (
                      <div style={{ color: 'red', marginTop: '4px' }}>{errors.libelle}</div>
                    )}
                  </FormControl>
                  ...
                  <FormControl fullWidth variant="standard">
                    ...
                    <Select
                      ...
                      onChange={(e) => {
                        ...
                        setFieldValue('continent', e.target.value as string);
                      }}
                    >

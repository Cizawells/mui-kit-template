...
export default function themePalette(theme: any) {
  return {
    ...
    table: {
      header: theme.colors?.tableHeader,
      subHeader: theme.colors?.tableSubHeader,
      hover: theme.colors?.tableHover,
      total: theme.colors?.tableTotal,
      subTotal: theme.colors?.tableSubTotal,
    },
    error: {
